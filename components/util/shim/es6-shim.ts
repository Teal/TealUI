 ...
 */
Object.is = Object.is || function (obj1: number, obj2: number) {
    if (obj1 === obj2) {
 ...
 */
Number.isInteger = Number.isInteger || ((value: number) => typeof value === "number" && isFinite(value) && Math.floor(value) === value);
