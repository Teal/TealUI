define(["require", "exports", "assert", "./number"], function (require, exports, assert, number) {
    ...
    function roundTest() {
        assert.strictEqual(number.round(1.25, 1), 1.3);
    }
    exports.roundTest = roundTest;
    function ceilTest() {
        assert.strictEqual(number.ceil(1.25, 1), 1.3);
    }
    exports.ceilTest = ceilTest;
    function floorTest() {
        assert.strictEqual(number.floor(1.25, 1), 1.2);
    }
    exports.floorTest = floorTest;
    function limitTest() {
