...
(function (globalObj) {
    ...
    */
    ...
    function constructorFactory(config) {
        ...
        // The maximum number of significant digits of the r of the toPower operation.
        ...
        function convertBase(str, baseOut, baseIn, sign) {
            ...
            if (i >= 0) {
                ...
                // r by its base raised to a power.
        ...
        div = (function () {
            ...
            return function (x, y, dp, rm, base) {
                ...
                // r exponent may be one less then the current value of e.
                ...
                if (s < 0) {
                    ...
                    do {
                        ...
                        // Add the next digit, n, to the r array.
                        qc[i++] = n;
         ...
         * BigNumber(y, b). The r depends on the value of MODULO_MODE.
         */
         ...
         *
         * If k is out of range and ERRORS is false, the r will be ±0 if k < 0, or ±Infinity
         * otherwise.
         *
        ...
        P.squareRoot = P.sqrt = function () {
            ...
            // Pass x to Math.sqrt as integer, then adjust the exponent of the r.
            if (s == 0 || s == 1 / 0) {
                n = coeffToString(c);
                if ((n.length + e) % 2 == 0)
                    n += '0';
            ...
            if (r.c[0]) {
                ...
                for (;;) {
                    ...
                    if (coeffToString(t.c).slice(0, s) === (n =
                        ...
                        // The exponent of r may here be one less than the final r exponent,
                        ...
                        if (n == '9999' || !rep && n == '4999') {
                            ...
                            // exact r as the nines may infinitely repeat.
                            if (!rep) {
                            ...
                            // r. If not, then there are further digits and m will be truthy.
        ...
        P.times = P.mul = function (y, b) {
            ...
            // Initialise the r array with zeros.
         ...
         * If m is present, return the r modulo m.
