define(["require", "exports"], function (require, exports) {
    ...
    function q(obj) {
        ...
        // variables
        var a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, obj2, d2, toSort, sortParas, ohaving, ot, coMax, co, labels, xLen, whereIndexes, distinct, distinctHash, ags, fieldCo, lastProp, distinctKey, pname, pname2, theVal, ag_type, agsCo, uu, orgD, o2, o3, intoAr, owhere, ewhere, setop, t1, t2, t1name, t2name, func, fh, tc, f2, lex, setopFuncHolder, joinFuncHolder;
        ...
        o = {};
        for (i in obj) {
            o[i.toUpperCase().split("_").join("")] = obj[i];
        }
        ;
        ...
        if (setop + !!o.SELECT + !!o.SELECTDISTINCT + !!o.INSERTINTO + !!o.UPDATE + !!o.DELETEFROM + !!o.UNPACK + !!o.PACK != 1) {
            return [];
        }
        else if (o.TESTSUB) {
            return "issub";
        ...
        if (d && typeof d == "object" && !d.push) {
            ...
            ;
            if (arguments.callee(o2) == "issub") {
                d = arguments.callee(d);
            }
        }
        ;
        // LIMIT
        ...
        if (setop) {
            setopFuncHolder = {
                f: function (o, a) {
                    var x = [], All, Type, dr = [], f = {}, f2 = {}, h = {}, k, o, hkey, hash = {}, testHash, testHashCo, mfd = [], d = o.UNIONDISTINCT || o.UNION || o.UNIONALL || o.INTERSECTDISTINCT || o.INTERSECT ||
                    ...
                    for (i in hash) {
                        ...
                        for (j = 0; j < hash[i].length; j++) {
                            testHash[hash[i][j].tableNo] = true;
                        }
                        ;
                        for (j in testHash) {
                            testHashCo++;
        ...
        if (o.ORDERBY && !o.ORDERBY.prep) {
            ...
            toSort.sort(function (x, y) {
                ...
                for (i = 0; i < a.length; i++) {
                    ...
                    ;
                    if ((m === true || m === false) && (n === true || n === false)) {
                        m *= -1;
                        n *= -1;
                    }
                    ;
        ...
        if (o.NATURALJOIN || o.USING) {
            ...
            for (i in d) {
                ...
                for (k = 0; k < x.length; k++) {
                    ...
                    ;
                    for (j = 0; j < o.USING.length; j++) {
                        h.push(x[k][o.USING[j]]);
                    }
                    ;
        ...
        if (o.JOIN && o.ON && !d.join && !o.JOIN.join) {
            ...
            ot = {}, k;
            for (j in d) {
                if (o.FULLOUTERJOIN || o.FULLJOIN || o.OUTERJOIN) {
                    k = true;
                    ot[j] = true;
                }
                ;
                if ((o.LEFTOUTERJOIN || o.LEFTJOIN) && !o.JOIN[j]) {
                    k = true;
                    ot[j] = true;
                }
                ;
                if ((o.RIGHTOUTERJOIN || o.RIGHTJOIN) && o.JOIN[j]) {
                    k = true;
                    ot[j] = true;
                }
                ;
        ...
        if (o.SELECT && o.SELECT.length > 0) {
            ...
            for (i = 0; i < d.length; i++) {
                ...
                for (j = 0; j < s.length; j++) {
                    ...
                    if (typeof s[j] == "string" && s[j].toLowerCase() == "|as|") {
                        j += 1;
                        continue;
                    }
                    ;
                    if (typeof s[j] == "string" && s[j].charAt(0) == "|" && s[j].charAt(s[j].length - 1) == "|") {
                        continue;
                    }
                    ;
                    ...
                    ;
                    if (o.JHELP && !o.JHELP[pname]) {
                        pname = o.JTNAME + pname;
                    }
                    ;
                    lastProp = pname;
                    obj[pname] = theVal;
...
//# sourceMappingURL=sqlike.js.map