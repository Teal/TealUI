define(["require", "exports"], function (require, exports) {
     ...
     * @param {Boolean} [specialChars] 是否使用特殊字符串。
     * @returns {String} 返回已混淆的代码。
     * @example obfuscate("var a =1")
     */
    function obfuscate(sourceCode, asciiEncoding, fastDecode, specialChars) {
        if (asciiEncoding === void 0) { asciiEncoding = 62; }
        if (fastDecode === void 0) { fastDecode = true; }
        if (specialChars === void 0) { specialChars = false; }
        return pack(sourceCode, asciiEncoding, fastDecode, specialChars);
    }
    exports.obfuscate = obfuscate;
    /**
     * 还原已混淆的 JavaScript 代码。
     * @param {String} obfuscatedCode 要还原的代码。
     * @returns {String} 返回还原后的代码。
     */
