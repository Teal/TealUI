define(["require", "exports", "assert", "./path"], function (require, exports, assert, path) {
    ...
    exports.isAbsoluteTest = isAbsoluteTest;
    ...
    exports.normalizeTest = normalizeTest;
    ...
    exports.dirnameTest = dirnameTest;
    ...
    exports.basenameTest = basenameTest;
    function extnameTest() {
    ...
    exports.extnameTest = extnameTest;
});
