...
YAHOO.compressor._extractComments = function(css, preservedTokens){
    var startIndex = 0,
        endIndex = 0,
        i = 0,
        max = 0,
...
//        comments.push(token);
//        css = css.slice(0, startIndex + 2) + "___YUICSSMIN_PRESERVE_CANDIDATE_COMMENT_" + (comments.length - 1) + "___" + css.slice(endIndex);
        css = css.slice(0, startIndex + 2) + "___YUICSSMIN_PRESERVE_CANDIDATE_COMMENT_" + (preservedTokens.length - 1) + "___" + css.slice(endIndex);
        startIndex += 2;
    }
...
YAHOO.compressor._restoreComments = function(css, preservedTokens){
    // restore preserved comments and strings
...
/**
 * used to preserve comments before analyze css content.
 * @param str {String} css file content
 * @return {String} css file content without comments
 */
//YAHOO.compressor.removeComments = function(str){
