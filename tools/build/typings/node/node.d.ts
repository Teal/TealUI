...
declare module "os" {
    ...
    export function networkInterfaces(): {[sourceIndex: string]: NetworkInterfaceInfo[]};
...
declare module "path" {
    ...
    export interface ParsedPath {
        ...
        dir: string;
        /**
         * The file name including extension (if any) such as 'sourceIndex.html'
         */
        base: string;
        /**
        ...
        ext: string;
        /**
         * The file name without extension (if any) such as 'sourceIndex'
         */
        name: string;
    }
