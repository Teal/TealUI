...
var FormControl = Control.extend({
    ...
    getInput: function () {
        ...
        return Dom(me.input).valueOf() || (me.input = me.dom.is("input,select,textarea") ? me.dom : me.dom.find("input,select,textarea").valueOf() || me.dom.parent().append('<input type="hidden" name="' + (me.dom.attr('name') || '') + '">'));
    },
