 ...
 * > 元字符区分大小写。
 */
export function format(_this: Date, format) {
 ...
 */
export function addDay(_this: Date, value) {
 ...
 */
export function addMonth(_this: Date, value) {
 ...
 */
export function isValid(year, month, day, hour, minute, second, milliSecond) {
    hour = hour || 0;
    minute = minute || 0;
    second = second || 0;
 ...
 */
export function addMinute(_this: Date, value) {
 ...
 */
export function dayLeft(_this: Date, month, day) {
 ...
 */
export function addYear(_this: Date, value) {
 ...
 */
export function addWeek(_this: Date, value) {
 ...
 */
export function getWeek(_this: Date, date) {
 ...
 */
export function getFirstDay(_this: Date, ) {
 ...
 */
export function getLastDay(_this: Date, ) {
    var result = new Date(+this);
    result.setDate(1);
