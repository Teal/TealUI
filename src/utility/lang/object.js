...
if (!Object.assign) {
    ...
    Object.assign = function (target, source) {
        /^o/.test(typeof console) && console.assert(target != null, "Object.assign(target: 不能为空, source)");
...
Object.each = function (iterable, fn, scope) {
    /^o/.test(typeof console) && console.assert(fn instanceof Function, "Object.each(iterable, fn: 必须是函数, [scope])");
