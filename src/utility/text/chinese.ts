 ...
 */
export function getPinYin(value: string, firstLetterOnly: boolean) {
 ...
 * @param value 要处理的中文。
 * @returns 返回转换后的中文。
 * @example Chinese.toSimple("簡") // "简"
 * @see Chinese.toTradional
 */
export function toSimple(value: string) {
    return convert(value, tradional, simple);
}
 ...
 * @param value 要处理的中文。
 * @returns 返回转换后的中文。
 * @example Chinese.toTradional("简") // "簡"
 * @see Chinese.toSimple
 */
export function toTradional(value: string) {
    return convert(value, simple, tradional);
}
