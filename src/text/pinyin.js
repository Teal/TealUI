...
var PinYin = (function () {
	...
	// GB2312 表： http://wiki.orz.asia/owen/index.php?title=Js%E6%B1%89%E5%AD%97%E8%BD%AC%E6%8B%BC%E9%9F%B3&oldid=452&printable=yes
	// UTF-8 表：  http://tech.byreach.com/node/222
	var dict = {
		'A': '啊阿吖嗄锕',
	...
	return {
		...
		getPinYinChar: function (ch) {
			for (var key in dict) {
				if (dict[key].indexOf(ch) >= 0) {
					return key;
				}
			}
			if (/[\u0020-\u007e]/.test(ch)) {
