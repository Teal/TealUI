declare module "assert" {
    /**
       ...
       */
    function async(acceptCallCount?: number): () => void;
     ...
     */
    function expect(amount: number): void;
     ...
     * @param {string} [message] A short description of the assertion
     */
    function notOk(state: any, message?: string): void;
     ...
     * @param {string} [message] A short description of the assertion
     */
    function notPropEqual(actual: any, expected: any, message?: string): void;
     ...
     * @param {string} [message] A short description of the assertion
     */
    function propEqual(actual: any, expected: any, message?: string): void;
     ...
     */
    function pushResult(assertResult: {
        result: boolean;
        actual: any;
        expected: any;
        message: string;
     ...
     * different name.
     */
    function throws(block: () => void, expected?: any, message?: any): void;
    function raises(block: () => void, expected?: any, message?: any): void;
